...
var productOne = new _class_product__WEBPACK_IMPORTED_MODULE_0__.Product('Padangos', '2000', '2010');
console.log(productOne);
productOne.addAProduct();
...
var Product = /*#__PURE__*/function () {
  function Product(product, price, year) {
  ...
  _createClass(Product, [{
    key: "getFullProductData",
    value: function getFullProductData() {
      return [this.product, this.price, this.year];
    }
  }, {
    key: "addAProduct",
    value: function addAProduct() {
      var ul = document.createElement('ul');
      var bodEl = document.querySelector('.products');
      ul.style.display = 'flex';
      ul.style.gap = '2rem';
      bodEl.appendChild(ul);
      var _iterator = _createForOfIteratorHelper(this.getFullProductData()),
        _step;
      try {
      ...
      var inputProduct = document.querySelector('.productName');
      var inputYear = document.querySelector('.productYear');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_1204jsone"] = self["webpackChunk_1204jsone"] || [];
